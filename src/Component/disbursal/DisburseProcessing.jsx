...
const DisbursalProcess = () => {
    ...
    const rows = disbursals?.map(disbursal => ({
        ...
        ...((activeRole === "disbursalHead" || activeRole === "admin") &&
            { disbursalManagerId: `${disbursal?.application?.disbursalManagerId?.fName}${disbursal?.application?.creditManagerId?.mName ? ` ${application?.creditManagerId?.mName}` : ``} ${application?.creditManagerId?.lName}`, })
